                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all ${
                      ...
                      <CheckCircleIcon className={`w-[1.125rem] h-[1.125rem] ${settings.status === 'published' ? 'text-white' : 'text-slate-400'}`} />
                    </div>
                    <div>
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all ${
                      ...
                      <ClockIcon className={`w-[1.125rem] h-[1.125rem] ${settings.status === 'pre_registration' ? 'text-white' : 'text-slate-400'}`} />
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-700 flex items-center gap-2">
                  <svg className="w-[1.125rem] h-[1.125rem]" viewBox="0 0 24 24" fill="none">
