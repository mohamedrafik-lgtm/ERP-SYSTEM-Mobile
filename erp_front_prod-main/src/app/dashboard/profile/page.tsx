                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      >
                        {showCurrentPassword ? <EyeSlashIcon className="w-[1.125rem] h-[1.125rem]" /> : <EyeIcon className="w-[1.125rem] h-[1.125rem]" />}
                      </button>
                    </div>
                  </FormControl>
                  <FormMessage />
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600"
                      >
                        {showNewPassword ? <EyeSlashIcon className="w-[1.125rem] h-[1.125rem]" /> : <EyeIcon className="w-[1.125rem] h-[1.125rem]" />}
                      </button>
                    </div>
                  </FormControl>
                  <FormMessage />
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600"
                      >
                        {showConfirmPassword ? <EyeSlashIcon className="w-[1.125rem] h-[1.125rem]" /> : <EyeIcon className="w-[1.125rem] h-[1.125rem]" />}
                      </button>
                    </div>
                  </FormControl>
                  <FormMessage />
