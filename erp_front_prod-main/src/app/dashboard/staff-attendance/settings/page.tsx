    ...
    try {
      ...
      if (data) {
        setForm({
          ...
          earlyCheckInMinutes: data.earlyCheckInMinutes ?? 15,
      ...
      <div className="max-w-4xl space-y-6">
        ...
        <div className="bg-white rounded-xl border border-tiba-gray-200 shadow-card p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <div>
              <label className="text-xs text-tiba-gray-500 block mb-1">الحضور المبكر (دقيقة)</label>
              <input type="number" value={form.earlyCheckInMinutes} onChange={e => setForm(f => ({ ...f, earlyCheckInMinutes: Number(e.target.value) }))} min="0"
                className="w-full px-3 py-2 text-sm border border-tiba-gray-200 rounded-xl focus:ring-2 focus:ring-tiba-primary-500/20 focus:border-tiba-primary-500 outline-none" />
              <p className="text-[10px] text-tiba-gray-400 mt-1">كم دقيقة قبل بداية الدوام يُسمح بالحضور</p>
            </div>
            <div>
