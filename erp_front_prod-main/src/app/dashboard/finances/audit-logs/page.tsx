...
const fieldNameTranslations: Record<string, string> = {
  ...
  allowPartialPayment: 'السماح بالسداد الجزئي',
  refundDeadlineEnabled: 'تفعيل مهلة الاسترداد',
  refundDeadlineAt: 'آخر موعد للاسترداد',
    ...
    <div className="space-y-6">
      ...
      <Card size="sm" hover={false} className="!p-0 !shadow-sm hidden md:block">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            <ShieldCheckIcon className="w-[1.125rem] h-[1.125rem] text-slate-400" />
