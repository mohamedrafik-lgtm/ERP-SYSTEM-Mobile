...
export default function TraineeAuthPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.sessionToken) localStorage.setItem('trainee_session_token', data.sessionToken);
  ...
  const handleCreatePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        if (loginData.sessionToken) localStorage.setItem('trainee_session_token', loginData.sessionToken);
        // حفظ التوكن كـ cookie ليقرأه الـ middleware
