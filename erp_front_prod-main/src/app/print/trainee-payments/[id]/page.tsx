    ...
    <div className="min-h-screen bg-white text-black font-cairo" dir="rtl" style={{margin: 0, padding: 0}}>
      ...
      <div className="print-container">
        ...
        <div className="header">
          ...
          <div className="date">
            تاريخ إصدار التقرير: {new Date().toLocaleString('ar-EG', { 
              weekday: 'long', 
              year: 'numeric', 
              month: 'long', 
              day: 'numeric',
            ...
            <table className="data-table">
              <thead>
                <tr>
                  ...
                  <th>تاريخ الدفع</th>
                  <th className="no-print">تم السداد بواسطة</th>
                  <th>الحالة</th>
                </tr>
              </thead>
              <tbody>
                {payments.map((payment, index) => {
                  ...
                  const paymentDates = paymentTransactions.map(transaction => ({
                    ...
                    createdByName: transaction.createdBy?.name || 'غير محدد'
                  }));
                  ...
                  return (
                    <tr key={payment.id}>
                      ...
                      <td className="no-print" style={{fontSize: '10px', lineHeight: '1.4'}}>
                        {paymentDates.length > 0 ? (
                          <div style={{display: 'flex', flexDirection: 'column', gap: '4px'}}>
                            {paymentDates.map((pd, idx) => (
                              <div key={idx} style={{borderBottom: idx < paymentDates.length - 1 ? '1px solid #e0e0e0' : 'none', paddingBottom: '3px'}}>
