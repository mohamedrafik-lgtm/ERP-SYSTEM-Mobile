...
export const SCREEN_PERMISSIONS: Record<string, ScreenPermissionConfig> = {
  ...
  StudentsList: {
    ...
    additionalPermissions: {
      ...
      export: { resource: 'dashboard.trainees', action: 'export_data' },
    },
    category: 'academic',
    priority: 2,
    showInMenu: true,
...
export const MENU_SECTIONS: MenuSection[] = [
  ...
  // ============ 3. الجداول الدراسية ============
  {
    ...
    category: 'schedules',
    icon: 'schedule',
    requiredPermissions: [{ resource: 'dashboard.schedule', action: 'view' }],
  ...
  // ============ 5. منصة الطلاب والأدوات ============
  {
    ...
    category: 'student_platform',
    icon: 'account-circle',
    requiredPermissions: [{ resource: 'dashboard.trainee-platform', action: 'view' }],
  ...
  },
  {
    ...
    category: 'academic_supplies',
    icon: 'inventory-2',
    requiredPermissions: [{ resource: 'study-materials', action: 'view' }],
  ...
  // ============ 10. الأتمتة والنظام ============
  {
    ...
    category: 'automation',
    icon: 'smart-toy',
    requiredPermissions: [{ resource: 'whatsapp', action: 'read' }],
  ...
  },
  {
    ...
    category: 'system',
    icon: 'settings',
    requiredPermissions: [{ resource: 'dashboard.permissions', action: 'manage' }],
